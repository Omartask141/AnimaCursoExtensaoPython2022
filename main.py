...
#int para que ser considerado como número senao ele e concederado como string
...
#Estrutura condicional - o famoso "SE" (if)#Se a pessoa for maior de idade, mostre "Você é maior de idade, ótimo! Já pode beber ou dirigir"
if idade >= 18:
